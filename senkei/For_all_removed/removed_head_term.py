#ページ見出し、タイトルから 
# all_vocab_senkeiあるいは、senkei_1500_new内の用語を抽出
...
def main(list_sitename,yogo_filename,ver,list_text_filename):
    ...
    #用語集合の追記用ファイルの生成
    shutil.copy('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/yogo/senkei/'+yogo_filename+'.csv','/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/yogo/senkei/'+yogo_filename+'_'+ver+'.csv')
    
    #用語集合の読み込み　リスト化
    df = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/yogo/senkei/'+yogo_filename+'_'+ver+'.csv')
    yogo_list = df[df['pattern'] != '×']['yogo'].tolist()
    #print(yogo_list)
    ...
    for i in range(len(list_text_filename)):
      ...
      for j in range(len(list_sitename)):
        ...
        dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/html_data_removed/removed_0621/removed_correspondence_list_'
        ...
        dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/For_all_removed/head_data_site/'
...
def add_term_csv(text_yogo_list,yogo_filename,ver):
  ...
  for i in range(len(only_text_yogo)):
    ...
    with open('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/yogo/senkei/'+yogo_filename+'_'+ver+'.csv', 'a', newline='') as f_object:  
...
def make_derectory(list_sitename,ver):
  ...
  create_directory =  '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/For_all_removed/head_data_site/' + directory_name
