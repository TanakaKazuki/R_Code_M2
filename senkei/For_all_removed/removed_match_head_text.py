  ...
  for i in range(len(list_textname)):
    ...
    for site_num in range(len(list_sitename)):
      ...
      for setu_num in range(len(df_text['setu_num'])):
        ...
        #サイト内全ページの見出し出現用語
        dir_ = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/For_all_removed/head_data_site/'
        ...
        dir_ = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/For_all_removed/text_match'
