...
def main(list_site,list_textname,limit,ver):
  ...
  for i in range(len(list_textname)):
    ...
    for j in range(len(list_site)):
      ...
      #人手マッチング結果の読み込み
      dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/hand_match/senkei/'+'0715'
      ...
      print(df_handmatch)
      #自動マッチング結果の読み込み
      dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/For_all_removed/text_match/senkeidaisugaku'
      df_match = pd.read_csv(dir+'/0621/'+textname+'_'+sitename+'_'+limit+'_0621.csv')
    ...
    dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/eval/'+ver
...
def check_match(df_handmatch,df_match,textname,sitename):
  ...
  dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/eval/'   
...
if __name__ == "__main__":    
    ...
    ver = '0715'
    limit = '2'
    main(list_sitename,list_textname,limit,ver)