  ...
  for i in range(len(input_name)):
    ...
    if input_file_name == 'correspondence_list':
      for j in range(len(list_sitename)):
        ...
        #   df = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/html_data/correspondence_list_'+site_name+'_正規.csv',header=None)
      ...
      df_output.to_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/Aggregation_data/all_page_num.csv',sep=',',index=None) 
      df_output.to_excel('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/Aggregation_data/all_page_num.xlsx') 
      ...
      for j in range(len(list_sitename)):
        ...
        #   column_pagenum.append(len(df))        
        #else:
        input_dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/html_data_removed/'
        #input_dir2 = 'removed_0511/'
        input_dir2 = 'removed_0621/'
...
def make_derectory():
  ...
  create_directory =  '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/senkei/Aggregation_data/' + directory_name
