...
def main(list_sitename,input_name):
  ...
  for i in range(len(input_name)):
    ...
    if input_file_name == 'correspondence_list':
      ...
      #除去ページのURLを取得
      df_remove_page = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/Removal_Key/removal_key.csv',encoding="shift jis")
      #各サイトの全ページから除去ページを除去
      for j in range(len(list_sitename)):
        ...
        #ufcpp.net
        if site_name == 'ufcpp.net':
          list_match_page_URL = ['https://ufcpp.net/study/math/vector_analysis','https://ufcpp.net/study/math/infinity',
                                 'https://ufcpp.net/study/math/set','https://ufcpp.net/study/math/hs',
                                 'https://ufcpp.net/study/math/linear','https://ufcpp.net/study/math/analysis',
                                 'https://ufcpp.net/study/math/group/','https://ufcpp.net/study/math/distribution',
                                 'https://ufcpp.net/study/math/elliptic','https://ufcpp.net/study/math/manifold',
                                 'https://ufcpp.net/study/math/miscmath']
...
def make_directory():
  ...
  create_directory =  '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/html_data_removed/' + directory_name
