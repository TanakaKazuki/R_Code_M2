...
def main(list_sitename,input_name,ver,ver2,limit):
  ...
  for i in range(len(list_sitename)):
    ...
    #人手マッチの結果
    df_handmatch = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/hand_match/'+ver2+'/handmatch_'+text_name+'_'+list_sitename[i]+'.csv')
    #全ページデータ
    df_page_data = pd.read_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/For_all_removed/head_data_site/'+ver+'/removed_'+list_sitename[i]+'_header_term.csv')
    ...
    df_handmatch.to_csv('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/yogo_bunpu/yogobunpu_'+list_sitename[i]+'.csv',sep=',',index=None)
    df_handmatch.to_excel('/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/yogo_bunpu/yogobunpu_'+list_sitename[i]+'.xlsx') 
