...
def main(list_sitename):
    ...
    for site in range(len(list_sitename)):
        ...
        dir = '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/html_data_removed/'
        #removed_correspondence_list_のバージョン
        correspondence_ver = '0511'
        ...
        #######0526修正部分#################
                #atarimae.biz対策
                if h_tag.attrib and sitename=='atarimae.biz':
        ...
        ###################################
            ...
            csv_file = Path(r'/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/For_all_removed/head_data/'+sitename+'_'+ver+'/removed_head_'+filename+'.csv')
...
def make_derectory(list_sitename):
  ...
  for i in range(len(list_sitename)):
    ...
    create_directory =  '/Users/kazuki/Desktop/research/data_Research_M2/R_Data_M2/kaiseki/For_all_removed/head_data/' + directory_name
